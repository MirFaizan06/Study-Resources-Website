...
<head>
  ...
  <title>${plan.title} — U.N.I.T.</title>
  <style>
...
<body>
  <div class="brand-header">
    <div class="brand-name">U.N.I.T.</div>
    <div class="brand-url">unit.in</div>
  </div>
  ...
  ${weekHtml}
  ${tipsHtml}
  <div class="pdf-footer">Generated by U.N.I.T. &middot; unit.in &middot; Free Educational Resource for Kashmiri Students</div>
</body>
</html>`
